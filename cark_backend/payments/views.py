                    ...
                    try:
                        ...
                        try:
                            ...
                            owner_notification = Notification.objects.create(  # type: ignore   
                                ...
                                message=f"Excellent! {renter_name} has successfully paid the deposit of {payment_obj.deposit_amount} EGP for your {car_name}. Your rental is now confirmed and ready for pickup. Please proceed with the handover process! 🎯",
                        ...
                        try:
                            ...
                            renter_notification = Notification.objects.create(  # type: ignore
                                ...
                                message=f"Perfect! Thank you for paying the deposit of {payment_obj.deposit_amount} EGP for {car_name} using {payment_method.replace('_', ' ')}. Your rental is now confirmed and ready for pickup on {rental.start_date.strftime('%Y-%m-%d at %H:%M')}. Please contact the owner to arrange the handover! 🎉",
                                notification_type="PAYMENT",
                                priority="HIGH",
                            ...
                            try:
                                ...
                                try:
                                    Notification.objects.create(  # type: ignore
                                        ...
                                        message=f"Excellent! {renter_name} has successfully paid the deposit of {payment_obj.deposit_amount} EGP for {car_name} using {payment_method.replace('_', ' ')}. Your rental is now confirmed!",
                                        notification_type="PAYMENT",
                                        priority="HIGH",
                                        data=notification_data,
                                        navigation_id="DEP_OWNER",
                                ...
                                try:
                                    Notification.objects.create(  # type: ignore
                                        ...
                                        receiver=rental.renter,
                                        title="✅ Deposit Payment Confirmed!",
                                        message=f"Perfect! Your deposit payment of {payment_obj.deposit_amount} EGP for {car_name} has been confirmed successfully. Your rental is now active!",
                                        notification_type="PAYMENT",
                                        priority="HIGH",
                                        data=renter_notification_data,
                    ...
                    if payment_obj:
                        ...
                        try:
                            Notification.objects.create(  # type: ignore    
                                ...
                                receiver=rental.car.owner,
                                title="💰 Deposit Payment Received!",
                                message=f"Excellent! {renter_name} has successfully paid the deposit of {payment_obj.deposit_amount} EGP for {car_name} using saved card. Your rental is now confirmed!",
                                notification_type="PAYMENT",
                                priority="HIGH",
                                data=notification_data,
                                navigation_id="DEP_OWNER",
