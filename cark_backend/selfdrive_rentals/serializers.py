...
class SelfDriveRentalSerializer(serializers.ModelSerializer):
    ...
    pickup_latitude = serializers.DecimalField(max_digits=20, decimal_places=15, required=False, write_only=True)
    pickup_longitude = serializers.DecimalField(max_digits=20, decimal_places=15, required=False, write_only=True)
    dropoff_latitude = serializers.DecimalField(max_digits=20, decimal_places=15, required=False, write_only=True)
    dropoff_longitude = serializers.DecimalField(max_digits=20, decimal_places=15, required=False, write_only=True)
